...
public class OlaMoneyPayManager extends PaymentManager {
    ...
    Context context ;
    Activity activity ;
    public OlaMoneyPayManager(Context context, Activity activity){
    ...
    public void invokeOlaMoney(PaymentDetailModel paymentDetailModel) {
        Toast.makeText(context, "ola cab exsist in mobile = " +check_olacabs(), Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            try {
                context.startActivity(new Intent(context, OLAWebViewActivity.class).putExtra(""+Config.PaymentGateways.Key_Merchent_Bill , ""+createMerchentBill(Config.PaymentGateways.OLA_Access_Token,paymentDetailModel.orderId , Config.PaymentGateways.OLA_Comment ,Config.PaymentGateways.OLA_UDF , Config.PaymentGateways.OLA_ReturnUrl , Config.PaymentGateways.OLA_Notify_URL , Config.PaymentGateways.OLA_Currency , ""+paymentDetailModel.amount , Config.PaymentGateways.OLA_CouponCode , Config.PaymentGateways.OLA_Access_Salt)));
