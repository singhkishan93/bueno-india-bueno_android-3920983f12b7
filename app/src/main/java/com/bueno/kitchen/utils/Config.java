package com.bueno.kitchen.utils;
...
public class Config {
    ...
    public interface Endpoints {
        ...
        String URL_LOCALITIES = URL_API + "/services.php?service_type=localities";
    ...
    public interface PaymentGateways {
        ...
        //MobiKwik
        String MOBIKWIK_URL_CHECKSUM_GENERATOR = "http://bueno.kitchen/webapi/payment.php/3/checksum";
        String MOBIKWIK_URL_CHECKSUM_VERIFY = "http://bueno.kitchen/webapi/payment.php/3/verify";
        String MOBIKWIK_MERCHANT_ID = "MBK6465";
        String MOBIKWIK_MERCHANT_NAME = "Bueno";

        //Paytm
        String PAYTM_URL_CHECKSUM_GENERATOR = "http://bueno.kitchen/webapi/payment.php/5/checksum";
        String PAYTM_URL_CHECKSUM_VERIFY = "http://bueno.kitchen/webapi/payment.php/5/verify";
    ...
    public interface URLs {
        String URL_FAQ = "http://bueno.kitchen/pages/faqs";
