...
import com.buenodelivery.kitchen.JSONParse.Data_Json_ngo;
import com.buenodelivery.kitchen.ParseJSON.data_JSON;
...
import com.buenodelivery.kitchen.activities.extras.AboutUsActivity;
import com.buenodelivery.kitchen.activities.extras.BecomePartnerActivity;
import com.buenodelivery.kitchen.activities.extras.BuenoCreditsActivity;
import com.buenodelivery.kitchen.activities.extras.BulkOrder;
import com.buenodelivery.kitchen.activities.extras.ContactUsActivity;
import com.buenodelivery.kitchen.activities.extras.FaqActivity;
import com.buenodelivery.kitchen.activities.extras.LoyalityActivity;
import com.buenodelivery.kitchen.activities.extras.OffersActivity;
import com.buenodelivery.kitchen.activities.extras.ReferActivity;
import com.buenodelivery.kitchen.activities.extras.WebViewDikshaActivity;
import com.buenodelivery.kitchen.activities.orders.OrdersListActivity;
import com.buenodelivery.kitchen.activities.prelogin.LoginActivity;
import com.buenodelivery.kitchen.activities.prelogin.WalkthroughActivity;
import com.buenodelivery.kitchen.activities.products.ProductListActivity;
...
import com.buenodelivery.kitchen.models.core.CategoryModel;
...
import com.buenodelivery.kitchen.models.utils.ProductCategoryModel;
import com.buenodelivery.kitchen.network.services.GoogleService;
import com.buenodelivery.kitchen.utils.Config;
import com.buenodelivery.kitchen.utils.RoundedTransformation;
...
public class MainActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener,
    ...
    @Bind(R.id.product_list_swipe_layout)
    public SwipeRefreshLayout productsSwipeRefreshLayout;
    @Bind(R.id.location_text_view)
    public TextView locationTextView;
    @Bind(R.id.locality_info_text_view)
    public TextView localityInfoTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enableBackButton();
        intnt =new Intent(this, AddressListActivity.class);
...
//        }
        ...
        performRedirection();
        sendRequest_dataJSON();
        sendRequest_dataJSON_ngo();
        //Toast.makeText(getApplicationContext(),"on create....!",Toast.LENGTH_LONG).show();
    }

    private void sendRequest_dataJSON(){
        StringRequest stringRequest = new StringRequest(Config.Endpoints.DataJSON_url,
                new com.android.volley.Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        show_DataJSON(response);
                    }
                },
    ...
    private void show_DataJSON(String json)
    {
        data_JSON dataJSON = new data_JSON(json);
        dataJSON.parseJSON();
        //parseJSON should be protected
    }

    private void sendRequest_dataJSON_ngo(){
        JsonObjectRequest JSONRequest = new JsonObjectRequest(Config.Endpoints.DataJSON_url,null,
                new com.android.volley.Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response_ngo) {
                        show_DataJSON_ngo(response_ngo);
                    }
                },
                new com.android.volley.Response.ErrorListener() {
                    @Override
    ...
    private void show_DataJSON_ngo(JSONObject json)
    {
        Data_Json_ngo data_Json_ngo = new Data_Json_ngo(json);
        data_Json_ngo.parseJSON();
        //parseJSON should be protected
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case REQUEST_LOGIN:
                    updateNavigationMenu();
                    //Toast.makeText(getApplicationContext(),"updateNavigationMenu....!",Toast.LENGTH_LONG).show();
                    break;
                case REQUEST_PLACE_PICKER:
                    ...
                    //Toast.makeText(getApplicationContext(),"REQUEST_PLACE_PICKER....!",Toast.LENGTH_LONG).show();
                    break;
...
//                            if(configResponseModel.minAndroidVersion>verCode)
                        ...
                        public Observable<ProductListResponseModel> call(LocalityModel localityModel) {
                            if (localityModel != null) {
                                if (localityModel.isLocationError()) {
                                    ...
                                    Log.d("addy_locality_id",localityModel.id+"");
                                    req_beans.setLocality_id(Integer.parseInt(localityModel.id));
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.rate_us:
                ...
                break;
//            case R.id.blog:
//                startActivity(new Intent(Intent.ACTION_VIEW).setData(Uri.parse("http://www.bueno.kitchen/blog/")));
//                break;
            ...
            case R.id.loyality:
                ...
                break;
            case R.id.diksha:
                Intent intent = new Intent(this, WebViewDikshaActivity.class);
                startActivity(intent);
                break;
            case R.id.become_a_Partner:
                startActivity(new Intent(this, BecomePartnerActivity.class));
                break;
            case R.id.bulk_order:
                startActivity(new Intent(this, BulkOrder.class));
                break;
        }
        return false;
    }
    ...
    public void performCheckout() {
        ...
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE); //remove action bar
        dialog.setContentView(R.layout.dialog_button);

        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.BLACK));
        dialog.setContentView(R.layout.dialog_button);
        tv_heading= (TextView)dialog.findViewById(R.id.tv_heading);
        ...
        if (req_beans.is_ordering_closed()) {

            Log.d("addy"," kitchen closed");

            tv_heading.setText("Kitchen Closed..! ");

            ((TextView) dialog.findViewById(R.id.tv_dialog_message)).setText(req_beans.getClosed_oredering_message());
            //Toast.makeText(getApplicationContext(),req_beans.getClosed_oredering_message(),Toast.LENGTH_LONG).show();
            //Log.d("get_addy_volley",req_beans.getClosed_oredering_message());
